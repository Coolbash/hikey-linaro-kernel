#
# Integration of kernel builidng into AOSP build system
#
...
ifeq ($(TARGET_ARCH),arm64)
 ...
 $(warning "only arm64 is supported")
endif
...
kernel-build: kernel-config
	$(MAKE) -C $(KERNEL_BUILD) ARCH=$(TARGET_ARCH) CROSS_COMPILE=$(TARGET_CROSS_COMPILE)
